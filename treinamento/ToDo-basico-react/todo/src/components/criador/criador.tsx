...
export default function Criador({ setDados }:TarefaProps){
    ...
    return(
        <form onSubmit={handleSubmit} className="flex gap-3">
            <input onChange={(e)=>setTarefa(e.target.value)} value={tarefa} className="bg-gray-300 p-1 rounded-md outline-none font-bold text-lg" type="text" name="tarefaNome" id="tarefaNome"/>
